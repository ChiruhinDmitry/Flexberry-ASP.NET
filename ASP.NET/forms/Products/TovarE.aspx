...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="TovarE.aspx.cs" Inherits="IIS.Практикум.ТоварE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlЕдиницыИзмеренияLabel" runat="server" Text="Единицы измерения" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlЕдиницыИзмерения" runat="server">
</asp:TextBox>
