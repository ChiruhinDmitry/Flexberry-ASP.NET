...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SkladE.aspx.cs" Inherits="IIS.Практикум.СкладE" %>
...
<asp:RequiredFieldValidator ID="ctrlКладовщикRequiredFieldValidator" runat="server" ControlToValidate="ctrlКладовщик"
                            ErrorMessage="Не указано: Кладовщик" Text="*" 
...
<div style="clear: left">
	<ac:AjaxGroupEdit CssClass="$PERCENTMW$descTxt" ID="ctrlТоварНаСкладе" runat="server" ReadOnly="false" />
</div>
