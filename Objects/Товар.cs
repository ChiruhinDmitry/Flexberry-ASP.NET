...
namespace IIS.Практикум
{
    ...
    [View("ТоварE", new string[] {
            ...
            "ЕдиницыИзмерения as \'Единицы измерения\'",
    ...
    public class Товар : ICSSoft.STORMNET.DataObject
    {
        ...
        private string fЕдиницыИзмерения;
        ...
        /// ЕдиницыИзмерения.
        /// </summary>
        // *** Start programmer edit section *** (Товар.ЕдиницыИзмерения CustomAttributes)

        // *** End programmer edit section *** (Товар.ЕдиницыИзмерения CustomAttributes)
        [StrLen(255)]
        public virtual string ЕдиницыИзмерения
        {
            get
            {
                // *** Start programmer edit section *** (Товар.ЕдиницыИзмерения Get start)

                // *** End programmer edit section *** (Товар.ЕдиницыИзмерения Get start)
                string result = this.fЕдиницыИзмерения;
                // *** Start programmer edit section *** (Товар.ЕдиницыИзмерения Get end)

                // *** End programmer edit section *** (Товар.ЕдиницыИзмерения Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Товар.ЕдиницыИзмерения Set start)

                // *** End programmer edit section *** (Товар.ЕдиницыИзмерения Set start)
                this.fЕдиницыИзмерения = value;
                // *** Start programmer edit section *** (Товар.ЕдиницыИзмерения Set end)

                // *** End programmer edit section *** (Товар.ЕдиницыИзмерения Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварE", typeof(IIS.Практикум.Товар));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварL", typeof(IIS.Практикум.Товар));
                }
            }
        }
    }
