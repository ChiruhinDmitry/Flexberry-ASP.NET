...
namespace IIS.Практикум
{
    ...
    public class ТоварНаСкладе : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Практикум.Склад fСклад;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Практикум.Склад.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.Практикум.Склад Склад
        {
            get
            {
                ...
                IIS.Практикум.Склад result = this.fСклад;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварНаСкладеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварНаСкладеE", typeof(IIS.Практикум.ТоварНаСкладе));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТоварНаСкладе : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Практикум.DetailArrayOfТоварНаСкладе members)

        // *** End programmer edit section *** (IIS.Практикум.DetailArrayOfТоварНаСкладе members)
        ...
        /// </summary>
        public DetailArrayOfТоварНаСкладе(IIS.Практикум.Склад fСклад) : 
                base(typeof(ТоварНаСкладе), ((ICSSoft.STORMNET.DataObject)(fСклад)))
        {
        }
        
        public IIS.Практикум.ТоварНаСкладе this[int index]
        {
            get
            {
                return ((IIS.Практикум.ТоварНаСкладе)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Практикум.ТоварНаСкладе dataobject)
        {
