...
namespace IIS.Практикум
{
    ...
    [View("НакладнаяE", new string[] {
            ...
            "Заказ as \'Заказ\'",
            "Заказ.Статус as \'Статус\'"}, Hidden=new string[] {
    ...
    [MasterViewDefineAttribute("НакладнаяE", "Заказ", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Статус")]
    ...
    public class Накладная : IIS.Практикум.Документ
    {
        
        private IIS.Практикум.СостояниеНакладной fСтатус;
        ...
        private IIS.Практикум.Сотрудник fМатериальноОтветственноеЛицо;
        
        private IIS.Практикум.Заказ fЗаказ;
        
        private IIS.Практикум.DetailArrayOfЗаписьВНакладной fЗаписьВНакладной;
        ...
        public virtual IIS.Практикум.СостояниеНакладной Статус
        {
            get
            {
                ...
                IIS.Практикум.СостояниеНакладной result = this.fСтатус;
        ...
        [NotNull()]
        public virtual IIS.Практикум.Сотрудник МатериальноОтветственноеЛицо
        {
            get
            {
                ...
                IIS.Практикум.Сотрудник result = this.fМатериальноОтветственноеЛицо;
        ...
        [NotNull()]
        public virtual IIS.Практикум.Заказ Заказ
        {
            get
            {
                ...
                IIS.Практикум.Заказ result = this.fЗаказ;
        ...
        public virtual IIS.Практикум.DetailArrayOfЗаписьВНакладной ЗаписьВНакладной
        {
            get
            {
                ...
                {
                    this.fЗаписьВНакладной = new IIS.Практикум.DetailArrayOfЗаписьВНакладной(this);
                }
                IIS.Практикум.DetailArrayOfЗаписьВНакладной result = this.fЗаписьВНакладной;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НакладнаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяE", typeof(IIS.Практикум.Накладная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НакладнаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяL", typeof(IIS.Практикум.Накладная));
                }
            }
        }
    }
