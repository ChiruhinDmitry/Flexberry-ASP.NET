...
namespace IIS.Практикум
{
    ...
    public class СтрокаЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Практикум.Товар fТовар;
        ...
        public virtual int Количество
        {
            ...
            set
            {
                ...
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException("Значение количества не может быть отрицательным");
                }
        ...
        [NotNull()]
        public virtual IIS.Практикум.Товар Товар
        {
            get
            {
                ...
                IIS.Практикум.Товар result = this.fТовар;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Практикум.Заказ.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СтрокаЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СтрокаЗаказаE", typeof(IIS.Практикум.СтрокаЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСтрокаЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Практикум.DetailArrayOfСтрокаЗаказа members)

        // *** End programmer edit section *** (IIS.Практикум.DetailArrayOfСтрокаЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfСтрокаЗаказа(IIS.Практикум.Заказ fЗаказ) : 
                base(typeof(СтрокаЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.Практикум.СтрокаЗаказа this[int index]
        {
            get
            {
                return ((IIS.Практикум.СтрокаЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Практикум.СтрокаЗаказа dataobject)
        {
