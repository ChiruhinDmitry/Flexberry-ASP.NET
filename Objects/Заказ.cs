...
namespace IIS.Практикум
{
    ...
    [BusinessServer("IIS.Практикум.ПроверкаНаличияТоваров, Практикум.BusinessServers", ICSSoft.STORMNET.Business.DataServiceObjectEvents.OnAllEvents)]
    [AutoAltered()]
    ...
    public class Заказ : IIS.Практикум.Документ
    {
        
        private IIS.Практикум.СостояниеЗаказа fСтатус;
        
        private System.DateTime fДатаОтгрузки;
        
        private System.DateTime fДатаОплаты;
        
        private IIS.Практикум.Сотрудник fМенеджер;
        
        private IIS.Практикум.DetailArrayOfСтрокаЗаказа fСтрокаЗаказа;
        ...
        public virtual IIS.Практикум.СостояниеЗаказа Статус
        {
            get
            {
                ...
                IIS.Практикум.СостояниеЗаказа result = this.fСтатус;
        ...
        [NotNull()]
        public virtual IIS.Практикум.Сотрудник Менеджер
        {
            get
            {
                ...
                IIS.Практикум.Сотрудник result = this.fМенеджер;
        ...
        public virtual IIS.Практикум.DetailArrayOfСтрокаЗаказа СтрокаЗаказа
        {
            get
            {
                ...
                {
                    this.fСтрокаЗаказа = new IIS.Практикум.DetailArrayOfСтрокаЗаказа(this);
                }
                IIS.Практикум.DetailArrayOfСтрокаЗаказа result = this.fСтрокаЗаказа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказE", typeof(IIS.Практикум.Заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказL", typeof(IIS.Практикум.Заказ));
                }
            }
        }
    }
