...
namespace IIS.Практикум
{
    ...
    public class ЗаписьВНакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Практикум.Накладная fНакладная;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Практикум.Накладная.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.Практикум.Накладная Накладная
        {
            get
            {
                ...
                IIS.Практикум.Накладная result = this.fНакладная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьВНакладнойE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьВНакладнойE", typeof(IIS.Практикум.ЗаписьВНакладной));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЗаписьВНакладной : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Практикум.DetailArrayOfЗаписьВНакладной members)

        // *** End programmer edit section *** (IIS.Практикум.DetailArrayOfЗаписьВНакладной members)
        ...
        /// </summary>
        public DetailArrayOfЗаписьВНакладной(IIS.Практикум.Накладная fНакладная) : 
                base(typeof(ЗаписьВНакладной), ((ICSSoft.STORMNET.DataObject)(fНакладная)))
        {
        }
        
        public IIS.Практикум.ЗаписьВНакладной this[int index]
        {
            get
            {
                return ((IIS.Практикум.ЗаписьВНакладной)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Практикум.ЗаписьВНакладной dataobject)
        {
