...
namespace IIS.Практикум
{
    ...
    [View("СкладE", new string[] {
            ...
            "Кладовщик.Фамилия as \'Фамилия\'"}, Hidden=new string[] {
            "Кладовщик.Фамилия"})]
    ...
    public class Склад : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Практикум.Сотрудник fКладовщик;
        
        private IIS.Практикум.DetailArrayOfТоварНаСкладе fТоварНаСкладе;
        ...
        [NotNull()]
        public virtual IIS.Практикум.Сотрудник Кладовщик
        {
            get
            {
                ...
                IIS.Практикум.Сотрудник result = this.fКладовщик;
        ...
        public virtual IIS.Практикум.DetailArrayOfТоварНаСкладе ТоварНаСкладе
        {
            get
            {
                ...
                {
                    this.fТоварНаСкладе = new IIS.Практикум.DetailArrayOfТоварНаСкладе(this);
                }
                IIS.Практикум.DetailArrayOfТоварНаСкладе result = this.fТоварНаСкладе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СкладE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладE", typeof(IIS.Практикум.Склад));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СкладL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладL", typeof(IIS.Практикум.Склад));
                }
            }
        }
    }
